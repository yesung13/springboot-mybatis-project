...
////////                            100);
//////                    Thumbnailator.createThumbnail(new FileInputStream(saveFile), thumbnail, 160,
//////                            100);
//////                    thumbnail.close();
//////                }
//////            } catch (Exception e) {
...
//     * @return
//     */
//    @PostMapping(value = "/uploadAjaxAct", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
//    @ResponseBody
//    public ResponseEntity<List<SAttachFileDTO>> uploadAjaxPost(MultipartFile[] uploadFile) {
//
//        List<SAttachFileDTO> list = new ArrayList<>();
//        String uploadFolder = "C:\\upload";
//
...
//        for (MultipartFile multipartFile : uploadFile) {
//
//            SAttachFileDTO attachDTO = new SAttachFileDTO();
//
//            String uploadFileName = multipartFile.getOriginalFilename();
//
//            // IE has file path
