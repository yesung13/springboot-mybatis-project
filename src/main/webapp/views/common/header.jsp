        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            ...
            <sec:authorize access="isAnonymous()">
                <form class="form-inline my-2 my-lg-0">
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}/nAccount/login">로그인</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="${pageContext.request.contextPath}/nAccount/signUp">회원가입</a>
                        </li>
                    </ul>
                </form>
            </sec:authorize>
                    ...
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="javascript:void(0);">
                                <span>
                                <c:if test="${userInfo.devCheck eq 'P'}">[예비 개발자] </c:if>
                                <c:if test="${userInfo.devCheck eq 'C'}">[경력 개발자] </c:if>
                                </span>
                                <span>${userInfo.accountUserNm}&nbsp;님</span>
                            </a>
                        </li>
                        <li class="nav-item">
